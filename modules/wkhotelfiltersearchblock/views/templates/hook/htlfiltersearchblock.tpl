...
<support@webkul.com>
    * @copyright 2010-2018 Webkul IN * @license https://store.webkul.com/license.html *}
    ...
    <div class="row margin-lr-0 block" id="filter_search_block">
        ...
        <div class="col-sm-12 category_page_search_block clear-both">
            <form method="POST" autocomplete="on" autofill="on">
                ...
                {/if} {if isset($location_enable) && $location_enable}
                <div class="form-group hotel_location_div">
                    <label class="control-label" for="">{l s='Hotel Location' mod='wkroomsearchblock'}</label>
                    <input class="form-control" placeholder="Enter a city, state, country name" type="text" id="hotel_location" name="hotel_location" autocomplete="off" {if isset($search_data)}value="{$search_data['location']}" city_cat_id="{$search_data['parent_data']['id_category']}"
                        {/if}/>
                    <div class="dropdown">
                ...
                <div class="form-group htl_nm_cont {if $totalActiveHotels <= 1 && !$show_only_active_htl}hidden{/if}">
                    <label class="control-label" for="">{l s='Hotel Name' mod='wkroomsearchblock'}</label> {if isset($all_hotels_info) && $totalActiveHotels}
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu hotel_dropdown_ul">
                            {if isset($all_hotels_info) && $all_hotels_info} {foreach from=$all_hotels_info key=htl_k item=htl_v}
    ...
    {strip} {addJsDefL name=no_results_found_cond}{l s='No results found for this search' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=hotel_loc_cond}{l s='Please enter a hotel location' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=hotel_name_cond}{l
    s='Please select a hotel name' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=check_in_time_cond}{l s='Please enter Check In time' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=check_out_time_cond}{l s='Please enter Check Out
    time' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=num_adults_cond}{l s='Please enter number of adults.' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=num_children_cond}{l s='Children' js=1 mod='wkroomsearchblock'}{/addJsDefL}
    {addJsDefL name=some_error_occur_cond}{l s='Some error occured. Please try again.' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDefL name=less_checkin_date}{l s='Use another date.' js=1 mod='wkroomsearchblock'}{/addJsDefL} {* {addJsDefL name=less_checkin_date}{l
    s='Check In date can not be before current date.' js=1 mod='wkroomsearchblock'}{/addJsDefL} *} {addJsDefL name=more_checkout_date}{l s='Check Out date must be greater than Check In date.' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDef autocomplete_search_url=$link->getModuleLink('wkroomsearchblock','autocompletesearch')}
    ...
    s='Please enter Check Out time' js=1 mod='wkroomsearchblock'}{/addJsDefL} {addJsDef max_order_date=$max_order_date} {addJsDef booking_date_to=$booking_date_to} {/strip}