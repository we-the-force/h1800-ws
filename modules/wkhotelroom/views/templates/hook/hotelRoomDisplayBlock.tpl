                                ...
                                <div class="margin-btm-30">
                                    ...
                                    <div class="hotelRoomDescContainer">
                                        ...
                                        <div class="row margin-lr-0" style="text-align: right;">
                                            ...
                                            {* <a target="" class="btn btn-default button htlRoomTypeBookNow" href="{$link->getProductLink($roomDisplay.id_product)|escape:'html':'UTF-8'}"><span>{if $lang_iso == 'es'} {l s='Reservar'} {elseif $lang_iso == 'en'} {l s='Book Now'} {/if}</span></a> *}
                                        </div>
                                    </div>
                                </div>
                            </div>
