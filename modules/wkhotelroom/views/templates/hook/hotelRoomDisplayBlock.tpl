                                    ...
                                    <div class="col-sm-12 col-md-6 margin-btm-30">
                                        ...
                                        <div class="hotelRoomDescContainer">
                                            ...
                                            <div class="row margin-lr-0" style="text-align: right;">
                                                <a target="blank" class="btn btn-default button htlRoomTypeBookNow" href="{$link->getProductLink($roomDisplay.id_product)|escape:'html':'UTF-8'}"><span>{l s='Reservar' mod='wkhotelroom'}</span></a>{* actualizar el problema del idioma *}
                                            </div>
                                        </div>
                                    </div>
                            {if !($smarty.foreach.htlRoom.iteration%2)}
