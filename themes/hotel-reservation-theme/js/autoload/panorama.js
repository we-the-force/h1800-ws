...
window.libpannellum = function(F, f, p) {
    function ja(Z) {
        ...
        function M(a, d, c, f, k, g) { this.vertices = a;
            this.side = d;
            this.level = c;
            this.x = f;
            this.y = k;
            ...
            if (g) {
                ...
                if (d.level < c.level) {
                    ...
                    if (l < m.tileResolution)
                        if (d.x ==
                            s && d.y != s) { if (I = y = 0.5, "d" == d.side || "u" == d.side) A = C = 0.5 } else d.x != s && d.y == s && (H = t = 0.5, "l" == d.side || "r" == d.side) && (A = C = 0.5);
        ...
        function wa(a) {
            ja(a, a.path + "." + m.extension,
                function(d, c) { a.texture = d;
                    a.textureLoaded = c ? 2 : 1 }, qa.crossOrigin)
        }

        function oa(a, d) { var c = [a[0] * d[0] + a[1] * d[1] + a[2] * d[2], a[4] * d[0] + a[5] * d[1] + a[6] * d[2], a[11] + a[8] * d[0] + a[9] * d[1] + a[10] * d[2], 1 / (a[12] * d[0] + a[13] * d[1] + a[14] * d[2])],
                f = c[0] * c[3],
                k = c[1] * c[3],
                c = c[2] * c[3],
                g = [0, 0, 0]; - 1 > f && (g[0] = -1);
            1 < f && (g[0] = 1); - 1 > k && (g[1] = -1);
            1 < k && (g[1] = 1); if (-1 > c || 1 < c) g[2] = 1; return g }

        function Ha() { console.log("Reducing canvas size due to error 1286!");
        ...
        this.init = function(G, d, Ra, L, k, g, e, s) {
            function z(a) { if (F) { var d = a * a * 4,
                        g = new Uint8ClampedArray(d),
                        c = s.backgroundColor ? s.backgroundColor : [0, 0, 0];
                    c[0] *= 255;
                    c[1] *= 255;
                    c[2] *= 255; for (var b = 0; b < d; b++) g[b++] = c[0], g[b++] = c[1], g[b++] = c[2];
                    a = new ImageData(g, a, a); for (n = 0; 6 > n; n++) 0 == m[n].width && (m[n] = a) } }
            ...
            if (!a && ("multires" == y && m.hasOwnProperty("fallbackPath") || "cubemap" == y) && ("WebkitAppearance" in
                ...
                var C = function() { 0 < this.width ? ($ === p && ($ = this.width), $ != this.width && console.log("Fallback faces have inconsistent widths: " + $ + " vs. " + this.width)) : F = !0;
                        R++;
        ...
        this.destroy = function() { Z !== p && (E !== p && Z.contains(E) && Z.removeChild(E), S !== p && Z.contains(S) && Z.removeChild(S)); if (a) { var c = a.getExtension("WEBGL_lose_context");
                c && c.loseContext() } };
        ...
        var ba = [],
            ja = function() {
                ...
                var f = 4,
                    l = {},
                    k;
                c.prototype.loadTexture = function(a, c, d) { this.texture = c;
                    this.callback = d;
                    this.image.src = a };
                for (var g = 0; g < f; g++) l[g] = new c;
                return function(c, g, m, n) { k = n;
                    n = a.createTexture();
                    f ? l[--f].loadTexture(g, n, m) : ba.push(new d(c, g, n, m)); return n }
            }()
    }
...
window.pannellum = function(F, f, p) {
    function ja(t, l) {
        function ra(a) { F.removeEventListener("deviceorientation", ra);
        ...
        function ja() {
            ...
            if (1 == a.getElementsByTagName("i").length) R();
                ...
                else { if (b.panorama === p) { R(b.strings.noPanoramaError); return }
                    Q = new Image }
                if ("cubemap" == b.type)
                    for (var v = 6, c = function() { v--;
                            0 === v && ta() }, e = function(a) {
                            var ha =
                                f.createElement("a");
        ...
        function Z(a) {
            ...
            h.addEventListener("loadend", function() {
                var v = h.result;
                if (navigator.userAgent.toLowerCase().match(/(iphone|ipod|ipad).* os 8_/)) { var c = v.indexOf("\u00ff\u00c2");
                ...
                if (-1 < c && !0 !== b.ignoreGPanoXMP) {
                    var d = v.substring(c,
                        ...
                        e = function(a) { var b;
                            0 <= d.indexOf(a + '="') ? (b = d.substring(d.indexOf(a + '="') + a.length + 2), b = b.substring(0, b.indexOf('"'))) : 0 <= d.indexOf(a + ">") && (b = d.substring(d.indexOf(a + ">") + a.length + 1), b = b.substring(0, b.indexOf("<"))); return b !== p ? Number(b) : null },
        ...
        function R(a) { a === p && (a = b.strings.genericWebGLError);
        ...
        function M(a) { var b = t.getBoundingClientRect(),
                v = {};
            v.x = (a.clientX || a.pageX) - b.left;
            v.y = (a.clientY || a.pageY) - b.top; return v }
        ...
        function Ma(a) { b.minHfov === b.hfov ? ga.setHfov(za, 1E3) : (a = pa(a), ga.lookAt(a[0], a[1], b.minHfov, 1E3)) }

        function pa(a) { var h = M(a);
            a = B.getCanvas(); var v = a.clientWidth,
                c = a.clientHeight;
            a = h.x / v * 2 - 1; var c = (1 - h.y / c * 2) * c / v,
            ...
            180 < a && (a -= 360); return [c, a] }

        function Ga(a) {
            if (la &&
                K) { O = Date.now(); var h = B.getCanvas(),
                    v = h.clientWidth,
                    h = h.clientHeight;
                a = M(a); var c = 180 * (Math.atan(Aa / v * 2 - 1) - Math.atan(a.x / v * 2 - 1)) / Math.PI * b.hfov / 90 + Pa;
        ...
        function wa(a) { la && (la = !1, 15 < Date.now() - O && (w.pitch = w.yaw = 0), J.classList.add("pnlm-grab"), J.classList.remove("pnlm-grabbing"), O = Date.now(), A("mouseup", a)) }
        ...
        function oa(a) {
            if (K &&
                ...
                Fa();
                b.roll = 0;
                w.hfov = 0; var h = M(a.targetTouches[0]);
                Aa = h.x;
                Ba = h.y; if (2 == a.targetTouches.length) { var v = M(a.targetTouches[1]);
                    Aa += 0.5 * (v.x - h.x);
                    Ba += 0.5 * (v.y - h.y);
        ...
        function a(a) {
            if ("touch" == a.pointerType)
                for (var b =
                        0; b < ma.length; b++)
                    if (a.pointerId == ma[b]) { Ca[b].clientX = a.clientX;
        ...
        function U(a) { if ("touch" == a.pointerType) { for (var b = !1, c = 0; c < ma.length; c++) a.pointerId == ma[c] && (ma[c] = p), ma[c] && (b = !0);
                b || (ma = [], Ca = [], E());
                a.preventDefault() } }
        ...
        function fa() {
            ...
            if (la || !0 === Y) requestAnimationFrame(fa);
                ...
                0 < a ? Va = setTimeout(function() { b.autoRotate = X;
                    ga.lookAt(Ia, p, za, 3E3);
                    D() }, a) : 0 <= b.autoRotateInactivityDelay && X && (b.autoRotate = X, ga.lookAt(Ia,
                    p, za, 3E3), D())
            }
        }
        ...
        function ya() {
            ...
            if (K) {
                ...
                a = b.yaw;
                var c = 0;
                if (b.avoidShowingBackground) { var d = b.hfov / 2,
        ...
        function ba() {
            try {
                ...
                !0 !== b.dynamic && (Q = p)
            } catch (c) { if ("webgl error" == c.type || "no webgl" == c.type) R();
        ...
        function ab() {
            if (b.sceneFadeDuration && B.fadeImg !== p) {
                ...
                var a = B.fadeImg;
                delete B.fadeImg;
                setTimeout(function() { N.removeChild(a);
        ...
        function G(a) {
            ...
            if (a.video) {
                ...
                N.appendChild(c);
                d.appendChild(e)
            } else if (a.image) { g = a.image;
                b.basePath && !sa(g) && (g = b.basePath + g);
                e = f.createElement("a");
                e.href = I(a.URL ? a.URL : g);
                e.target = "_blank";
                d.appendChild(e); var k = f.createElement("img");
                k.src = I(g);
                k.style.width = a.width + "px";
                k.style.paddingTop = "5px";
                N.appendChild(c);
                e.appendChild(k);
                d.style.maxWidth = "initial" } else if (a.URL) {
                e = f.createElement("a");
                e.href = I(a.URL);
                if (a.attributes)
                ...
                e.appendChild(c)
            } else a.sceneId && (c.onclick = c.ontouchend = function() { c.clicked || (c.clicked = !0, Sa(a.sceneId, a.targetPitch, a.targetYaw, a.targetHfov)); return !1 }, c.className += " pnlm-pointer", d.className += " pnlm-pointer"), N.appendChild(c);
        ...
        function d() { Wa || (b.hotSpots ? (b.hotSpots = b.hotSpots.sort(function(a, b) { return a.pitch < b.pitch }), b.hotSpots.forEach(G)) : b.hotSpots = [], Wa = !0, b.hotSpots.forEach(L)) }
        ...
        function Ra() {
            ...
            delete b.hotSpots;
            if (a)
                for (var c = 0; c < a.length; c++) { var d = a[c].div; if (d) { for (; d.parentNode && d.parentNode != N;) d = d.parentNode;
                        N.removeChild(d) }
                    delete a[c].div }
        }
        ...
        function s(a) { f.fullscreenElement || f.fullscreen || f.mozFullScreen || f.webkitIsFullScreen || f.msFullscreenElement ? (u.fullscreen.classList.add("pnlm-fullscreen-toggle-button-active"), Da = !0) : (u.fullscreen.classList.remove("pnlm-fullscreen-toggle-button-active"), Da = !1); "resize" !== a && A("fullscreenchange", Da);
            B.resize();
            n(b.hfov);
            D() }
        ...
        function x() { Oa && (q.load.box.style.display = "none", q.errorMsg.style.display = "none", Oa = !1, A("errorcleared"));
            K = !1;
            u.load.style.display = "none";
        ...
        function Sa(a, c, d, e, f) {
            ...
            P = {};
            var m, n;
            if (b.sceneFadeDuration && !f && (m = B.render(b.pitch * Math.PI / 180, b.yaw * Math.PI / 180, b.hfov * Math.PI / 180, { returnImage: !0 }), m !== p)) {
                f = new Image;
                f.className = "pnlm-fade-img";
                f.style.transition = "opacity " + b.sceneFadeDuration / 1E3 + "s";
                f.style.width = "100%";
                f.style.height = "100%";
                f.onload = function() { Sa(a, c, d, e, !0) };
                f.src = m;
                N.appendChild(f);
                B.fadeImg = f;
                return
        ...
        function Fa() { F.removeEventListener("deviceorientation", qa);
        ...
        function H(a) { return l.escapeHTML ? String(a).split(/&/g).join("&amp;").split('"').join("&quot;").split("'").join("&#39;").split("<").join("&lt;").split(">").join("&gt;").split("/").join("&#x2f;").split("\n").join("<br>") : String(a).split("\n").join("<br>") }

        function I(a) { return 0 === a.trim().toLowerCase().indexOf("javascript:") ? "about:blank" : a }
        ...
        u.load.addEventListener("click", function() { g();
            x() });
        ...
        var ma = [],
            Ca = [];
        aa.prototype.multiply = function(a) { return new aa(this.w * a.w - this.x * a.x - this.y * a.y - this.z * a.z, this.x * a.w + this.w * a.x + this.y * a.z - this.z * a.y, this.y * a.w + this.w * a.y + this.z * a.x - this.x * a.z, this.z * a.w + this.w * a.z + this.x * a.y - this.y * a.x) };
        ...
        this.setPitch = function(a, c, d, e) { O = Date.now(); if (1E-6 >= Math.abs(a - b.pitch)) return "function" == typeof d && d(e), this;
            (c = c == p ? 1E3 : Number(c)) ? (P.pitch = { startTime: Date.now(), startPosition: b.pitch, endPosition: a, duration: c }, "function" == typeof d && setTimeout(function() { d(e) }, c)) : b.pitch = a;
            D(); return this };
        ...
        this.setYaw = function(a, c, d, e) { O = Date.now(); if (1E-6 >= Math.abs(a - b.yaw)) return "function" == typeof d && d(e), this;
            c = c == p ? 1E3 : Number(c);
            a = (a + 180) % 360 - 180;
        ...
        this.setYawBounds = function(a) { b.minYaw = Math.max(-180, Math.min(a[0], 180));
            b.maxYaw = Math.max(-180, Math.min(a[1], 180)); return this };
        this.getHfov = function() { return b.hfov };
        this.setHfov = function(a, c, d, e) { O = Date.now(); if (1E-6 >= Math.abs(a - b.hfov)) return "function" == typeof d && d(e), this;
            (c = c == p ? 1E3 : Number(c)) ? (P.hfov = { startTime: Date.now(), startPosition: b.hfov, endPosition: z(a), duration: c }, "function" == typeof d && setTimeout(function() { d(e) }, c)) : n(a);
            D(); return this };
        ...
        this.lookAt = function(a, c, d, e, f, g) { e = e == p ? 1E3 : Number(e);
            a !== p && 1E-6 < Math.abs(a - b.pitch) && (this.setPitch(a, e, f, g), f = p);
            c !== p && 1E-6 < Math.abs(c - b.yaw) && (this.setYaw(c, e, f, g), f = p);
            d !== p && 1E-6 < Math.abs(d - b.hfov) && (this.setHfov(d, e, f, g), f = p); "function" == typeof f && f(g); return this };
        ...
        this.setHorizonRoll = function(a) { b.horizonRoll = Math.min(90, Math.max(-90, a));
        ...
        this.stopAutoRotate = function() { X = b.autoRotate ? b.autoRotate : X;
            b.autoRotate = !1;
            b.autoRotateInactivityDelay = -1; return this };
        this.stopMovement = function() { Ea();
            w = { yaw: 0, pitch: 0, hfov: 0 } };
        this.getRenderer = function() { return B };
        this.setUpdate = function(a) { Na = !0 === a;
            B === p ? ta() : D(); return this };
        this.mouseEventToCoords = function(a) { return pa(a) };
        this.loadScene = function(a, b, c, d) {!1 !== K && Sa(a, b, c, d); return this };
        this.getScene = function() { return b.scene };
        this.addScene = function(a,
            b) { l.scenes[a] = b; return this };
        this.removeScene = function(a) { if (b.scene === a || !l.scenes.hasOwnProperty(a)) return !1;
            delete l.scenes[a]; return !0 };
        ...
        this.removeHotSpot = function(a, c) {
            if (c === p || b.scene == c) { if (!b.hotSpots) return !1; for (var d = 0; d < b.hotSpots.length; d++)
                    if (b.hotSpots[d].hasOwnProperty("id") && b.hotSpots[d].id === a) { for (var e = b.hotSpots[d].div; e.parentNode != N;) e = e.parentNode;
                        N.removeChild(e);
                        delete b.hotSpots[d].div;
                        b.hotSpots.splice(d, 1); return !0 } } else if (l.scenes.hasOwnProperty(c)) {
        ...
        this.isOrientationSupported = function() { return ua || !1 };
        ...
        this.off =
            function(a, b) { if (!a) return T = {}, this; if (b) { var c = T[a].indexOf(b);
                    0 <= c && T[a].splice(c, 1);
                    0 == T[a].length && delete T[a] } else delete T[a]; return this };
        this.destroy = function() {
            B && B.destroy();
            Ta && (f.removeEventListener("mousemove", Ga, !1), f.removeEventListener("mouseup", wa, !1), t.removeEventListener("mozfullscreenchange", s, !1), t.removeEventListener("webkitfullscreenchange", s, !1), t.removeEventListener("msfullscreenchange", s, !1), t.removeEventListener("fullscreenchange", s, !1), F.removeEventListener("resize", ka, !1), F.removeEventListener("orientationchange", ka, !1), t.removeEventListener("keydown", $, !1), t.removeEventListener("keyup", xa, !1), t.removeEventListener("blur", S, !1), f.removeEventListener("mouseleave", wa, !1));
            t.innerHTML = "";
            t.classList.remove("pnlm-container")
        }
    }
    return { viewer: function(f, l) { return new ja(f, l) } }
}(window, document);