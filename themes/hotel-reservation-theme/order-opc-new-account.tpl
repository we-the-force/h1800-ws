        ...
        <div id="opc_account_choice" class="row">
            <div class="col-xs-12">
                <div class="opc-button">
                    {* <a class="btn btn-default button button-medium user_login navigation-link" href="{$link->getPageLink('my-account', true)|escape:'html'}" rel="nofollow" title="{l s='Log in to your customer account' mod='blockuserinfo'}">
