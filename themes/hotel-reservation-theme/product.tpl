							...
							<form action="" method="post">
								...
								{if $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
									...
									<div class="input-group">
										...
										<label class="input-group-addon" for="check_in_time"><i
								...
								<div class="form-group col-sm-6" id="quantity_wanted_p" {if (!$allow_oosp && $product-> quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
											...
											<div class="qty_sec_cont">
												...
												<div class="qty_input_cont row margin-lr-0">
													<input autocomplete="off" type="text" min="1" name="qty"
													...
													<input type="hidden" id="num_days"
														value="{if isset($num_days)}{$num_days|escape:'html':'UTF-8'}{/if}">
													<input type="hidden" id="max_avail_type_qty"
														value="{if isset($total_available_rooms)}{$total_available_rooms|escape:'html':'UTF-8'}{/if}">
												</div>
